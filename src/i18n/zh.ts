const zh = {
  ...
  fish: {
    title: "小鱼（Fish）",
    hint: "小鱼是无状态的子 Agent，主 Agent 通过 call_fish 把「只关注结果」的轻量任务（扫描、收集、归纳、抽取）交给它，子任务过程不污染主对话。小鱼运行在全局「内置小模型（Flash）」上，使用只读工具集。",
    builtin: "内置",
    user: "自定义",
    add: "添加小鱼",
    edit: "编辑小鱼",
    ...
    name: "名称",
    description: "简介",
    descriptionPlaceholder: "一句话说明这条小鱼适合什么任务",
    systemPrompt: "角色提示词",
    systemPromptPlaceholder: "描述这条小鱼的职责与输出要求……",
    fromSkillTitle: "从技能生成小鱼",
    fromSkillHint: "把已安装的技能转换为一条小鱼，便于在委派任务中直接调用。",
    fromSkillAction: "生成小鱼",
  },
  ...
  settings: {
    ...
    flashModel: "内置小模型",
    flashModelHint: "勾选后，该模型作为全局「内置小模型（Flash）」，供委派子 Agent（小鱼 Fish）执行只关注结果的轻量任务；未勾选则子 Agent 使用主模型。",
    mcpServers: "MCP 服务器",
  ...
  agent: {
    ...
    placeholder: "描述 Agent 任务（Enter 运行，Shift+Enter 换行，↑↓ 回顾历史发送）",
    run: "运行",
    stop: "停止",
    artifacts: "产物",
    previewFile: "文件",
