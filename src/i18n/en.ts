const en = {
  ...
  studio: {
    ...
    workflowHintHelp:
      "Execution follows org_spec and depends_on; this hint only shapes the swarm coordinator system protocol (waves / sequential / review).",
  ...
  workflow: {
    ...
    waitingHumanBanner: "Workflow paused — fill in the human node below and submit to continue.",
  ...
  anonymousAgent: {
    ...
    hint: "Anonymous agents are stateless helpers. The main agent delegates result-only work via delegate without polluting the main session. They run on the global flash model with a read-only tool surface.",
    builtin: "Builtin",
    user: "Custom",
    ...
    name: "Name",
    description: "Description",
    descriptionPlaceholder: "One line on what this anonymous agent is good for",
    systemPrompt: "Role prompt",
    systemPromptPlaceholder: "Describe this anonymous agent's responsibility and output…",
    fromSkillTitle: "Create anonymous agent from skill",
    fromSkillHint: "Turn an installed skill into an anonymous agent for direct delegation.",
    fromSkillAction: "Create anonymous agent",
  },
  ...
  library: {
    ...
    localPlaceholder: "Local path or manifest/zip URL",
    install: "Install",
  ...
  collab: {
    ...
    col_done: "Done",
    cardWaitingDependency: "Waiting on dependency",
    cliWaiting: "Waiting for output…",
  },
  ...
  settings: {
    title: "Settings · LLM",
    titleHub: "Settings",
    subtitleHub: "Models & runtime environment",
    tabModels: "Models",
    tabChannels: "Message channels",
    tabSkills: "Skills",
    tabStudio: "Studio",
  ...
  chat: {
    ...
    removeChip: "Remove",
    skills: "Skills",
    skillsEmpty: "No skills installed — open Resource library",
    connectors: "Connectors",
    connectorsEmpty: "No connectors installed — open Resource library",
  ...
  agent: {
    ...
    chatroomEmpty: "No member conversation yet — wait for the task to progress",
    coordinationEmpty: "No coordination records yet — wait for the task to progress",
    todoWaitingDependency: "Waiting on upstream todo: {{id}}",
    poolMemberDetail: "Member assistant detail",
    run: "Run",
    stop: "Stop",
    artifacts: "Artifacts",
    previewFile: "File",
