const en = {
  ...
  fish: {
    title: "Fish",
    hint: "Fish are stateless sub-agents. The main agent uses call_fish to hand off result-only jobs (scan, collect, summarize, extract) so their steps never bloat the conversation. Fish run on the global flash model with a read-only tool surface.",
    builtin: "Builtin",
    user: "Custom",
    add: "Add Fish",
    edit: "Edit Fish",
    ...
    descriptionPlaceholder: "One line on what this Fish is good for",
    systemPrompt: "Role prompt",
    systemPromptPlaceholder: "Describe this Fish's responsibility and output…",
    fromSkillTitle: "Create Fish from skill",
    fromSkillHint: "Turn an installed skill into a Fish so it can be delegated directly.",
    fromSkillAction: "Create Fish",
  },
  ...
  settings: {
    ...
    flashModelHint: "When checked, this model becomes the global \"flash\" small model used by delegated sub-agents (Fish) for lightweight, result-only tasks; otherwise sub-agents use the main model.",
  ...
  extensions: {
    ...
    hostOffHint: "Open Extensions sidebar, install from Open VSX, then enable an extension",
  ...
  agent: {
    ...
    placeholder: "Describe a task for the agent (Enter run, Shift+Enter newline, ↑↓ recall history)",
    run: "Run",
    stop: "Stop",
    artifacts: "Artifacts",
    previewFile: "File",
