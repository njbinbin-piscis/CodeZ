...
export default function AssistantsTab() {
  ...
  const renderStatus = (name: string) => {
    ...
    return (
      <span className="codez-wb-meta" style={{ color }}>
        ● {text}
      </span>
    );
  };
  ...
  return (
    <div className="codez-settings-tabpanel">
      <section className="codez-settings-section">
        ...
        {notice && <div className="codez-settings-hint">{notice}</div>}

        {/* 飞书 */}
        <div className="codez-wb-row" style={{ flexDirection: "column", alignItems: "stretch", gap: 8 }}>
        ...
        <div className="codez-wb-row" style={{ flexDirection: "column", alignItems: "stretch", gap: 8 }}>
          ...
          {qrMsg && <div className="codez-settings-hint">{qrMsg}</div>}
          {qr && (
            <img
              src={qr}
              alt="微信登录二维码"
        ...
        <div className="codez-wb-actions" style={{ marginTop: 12 }}>
