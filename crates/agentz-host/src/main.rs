//! AgentZ host shell — bootstrap skeleton.
//!
//! AgentZ is a Cursor-like AI IDE with two first-class modes (IDE / Agent)
...
//! `docs/agentz-design.md`.

fn main() {
    println!("AgentZ host — Cursor-like AI IDE on the piscis-engine kernel");
